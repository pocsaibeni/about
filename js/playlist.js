function _0x1c6e(_0x39e522, _0x4608d8) {
    ...
    return _0x1c6e = function(_0x1c6eae, _0x3c3250) {
...
(function(_0x5c72f4, _0x1b8076) {
    ...
    while (!![]) {
        try {
            const _0x500bdc = parseInt(_0x58f75a(0x127)) / 0x1 * (parseInt(_0x58f75a(0x11f)) / 0x2) + parseInt(_0x58f75a(0x118)) / 0x3 * (parseInt(_0x58f75a(0x11e)) / 0x4) + parseInt(_0x58f75a(0x120)) / 0x5 * (parseInt(_0x58f75a(0x129)) / 0x6) + -parseInt(_0x58f75a(0x125)) / 0x7 + -parseInt(_0x58f75a(0x11a)) / 0x8 + parseInt(_0x58f75a(0x11c)) / 0x9 + parseInt(_0x58f75a(0x119)) / 0xa * (-parseInt(_0x58f75a(0x116)) / 0xb);
...
function playSong(_0x5e19c5) {
    ...
    audio[_0x64963e(0x128)] = _0x4e9d9f[_0x64963e(0x122)], audio[_0x64963e(0x11d)](), songTitle['textContent'] = _0x4e9d9f[_0x64963e(0x117)] + _0x64963e(0x124) + _0x4e9d9f[_0x64963e(0x11b)];
}

function _0x48da() {
    const _0x1f120e = ['576015mGOxMw', 'title', '3ikqKMv', '190MsjUiC', '664456vcsrXh', 'artist', '7611129MPRmpX', 'play', '2784632xnMOkO', '140604yiDEQu', '10PilAXS', 'getElementById', 'file', 'length', '\x20-\x20', '2959334BvtRLq', 'ended', '3IqjPKf', 'src', '623994OqwUDi'];
    _0x48da = function() {
        return _0x1f120e;
    };
    return _0x48da();
...
audio['addEventListener'](_0xa0ea6(0x126), () => {
    ...
    currentSongIndex++, currentSongIndex >= playlist[_0x3a9924(0x123)] && (currentSongIndex = 0x0), playSong(currentSongIndex);
